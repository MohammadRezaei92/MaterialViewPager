...
import static com.github.florent37.materialviewpager.MaterialViewPagerHelper.getAnimator;
...
public class MaterialViewPager extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private onHeaderExpand onHeaderExpand;

    public interface onHeaderExpand{
        void headerExpanded();
    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        MaterialViewPagerAnimator animator = getAnimator(this.getContext());
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        ss.yOffset = getAnimator(getContext()).lastYOffset;
    ...
    public void setColor(int color, int fadeDuration) {
        if (getAnimator(getContext()) != null) {
            getAnimator(getContext()).setColor(color, fadeDuration * 2);
        }
    }
    ...
    public void onPageScrollStateChanged(int state) {
        ...
        if (settings.displayToolbarWhenSwipe) {
            getAnimator(getContext()).onViewPagerPageChanged();
        }
    }
    ...
    public void setHeight(int height){
        settings.headerHeight = height;
        initialiseHeights();
    }

    public void setLogoMargin(int marginTop) {
        marginTop = marginTop - (30);
        settings.logoMarginTop = marginTop;
        if (settings.logoMarginTop != 0) {
            RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) logoContainer.getLayoutParams();
            layoutParams.setMargins(0, settings.logoMarginTop, 0, 0);
            logoContainer.setLayoutParams(layoutParams);
    ...
    public void restoreLayout(){
        final RecyclerView recyclerView = (RecyclerView) MaterialViewPagerHelper.getAnimator(getContext()).getRecyclerView();
